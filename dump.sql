...
INSERT INTO `contact_info_city` VALUES (2,'Львів','lviv');
/*!40000 ALTER TABLE `contact_info_city` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `contact_info_city_numbers`
--

DROP TABLE IF EXISTS `contact_info_city_numbers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `contact_info_city_numbers` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `city_id` bigint NOT NULL,
  `number_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `contact_info_city_numbers_city_id_number_id_762e85b0_uniq` (`city_id`,`number_id`),
  KEY `contact_info_city_nu_number_id_61d6718d_fk_contact_i` (`number_id`),
  CONSTRAINT `contact_info_city_nu_city_id_140169ca_fk_contact_i` FOREIGN KEY (`city_id`) REFERENCES `contact_info_city` (`id`),
  CONSTRAINT `contact_info_city_nu_number_id_61d6718d_fk_contact_i` FOREIGN KEY (`number_id`) REFERENCES `contact_info_number` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `contact_info_city_numbers`
--

LOCK TABLES `contact_info_city_numbers` WRITE;
/*!40000 ALTER TABLE `contact_info_city_numbers` DISABLE KEYS */;
INSERT INTO `contact_info_city_numbers` VALUES (1,2,1),(2,2,2),(3,2,3);
/*!40000 ALTER TABLE `contact_info_city_numbers` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `contact_info_number` VALUES (1,'0 800 338 695'),(2,'067 35 09 635'),(3,'093 17 07 333');
...
INSERT INTO `django_admin_log` VALUES (1,'2022-04-06 20:40:06.723632','3','Тотальний Розпродаж',1,'[{\"added\": {}}]',7,1),(2,'2022-04-06 21:06:37.604911','2','2342424',1,'[{\"added\": {}}]',8,1),(3,'2022-04-06 21:06:42.220002','3','23423442',1,'[{\"added\": {}}]',8,1),(4,'2022-04-06 21:06:44.077473','4','24242',1,'[{\"added\": {}}]',8,1),(5,'2022-04-06 21:10:49.211431','1','Львів',1,'[{\"added\": {}}]',9,1),(6,'2022-04-11 20:05:37.971584','1','Alert',1,'[{\"added\": {}}]',12,1),(7,'2022-04-13 19:35:58.308135','1','Alert',3,'',12,1),(8,'2022-04-13 19:36:27.872315','2','iPhone',1,'[{\"added\": {}}]',12,1),(9,'2022-04-13 19:36:42.427344','3','Mac',1,'[{\"added\": {}}]',12,1),(10,'2022-04-13 19:36:51.336906','4','Apple Watch',1,'[{\"added\": {}}]',12,1),(11,'2022-04-13 19:36:55.807827','5','iPad',1,'[{\"added\": {}}]',12,1),(12,'2022-04-13 19:37:01.725706','6','Airpods',1,'[{\"added\": {}}]',12,1),(13,'2022-04-13 19:37:07.414226','7','Гаджети',1,'[{\"added\": {}}]',12,1),(14,'2022-04-13 19:37:12.091219','8','Акустика',1,'[{\"added\": {}}]',12,1),(15,'2022-04-13 19:37:16.451698','9','Аксесуари',1,'[{\"added\": {}}]',12,1),(16,'2022-04-13 19:37:21.583626','10','Вживана техніка',1,'[{\"added\": {}}]',12,1),(17,'2022-04-13 19:37:40.929949','1','0 800 338 695',1,'[{\"added\": {}}]',10,1),(18,'2022-04-13 19:37:47.593140','2','067 35 09 635',1,'[{\"added\": {}}]',10,1),(19,'2022-04-13 19:37:53.103954','3','093 17 07 333',1,'[{\"added\": {}}]',10,1),(20,'2022-04-13 19:44:59.982393','2','Львів',1,'[{\"added\": {}}]',11,1),(21,'2022-04-13 19:45:07.034978','2','Львів',2,'[]',11,1);
...
INSERT INTO `products_category` VALUES (2,'iPhone','','iphone'),(3,'Mac','','mac'),(4,'Apple Watch','','apple-watch'),(5,'iPad','','ipad'),(6,'Airpods','','airpods'),(7,'Гаджети','','gadzheti'),(8,'Акустика','','akustika'),(9,'Аксесуари','','aksesuari'),(10,'Вживана техніка','','vzhivana-tehnika');
...
INSERT INTO `user_user` VALUES (1,'pbkdf2_sha256$320000$4L7AGuoMYP3n4O25thiEoy$zh5ApE9ftZNs9ndMrAw7r1xAZ1lC692MevQczVUtjjY=','2022-04-13 19:35:42.733084',1,'admin@ff.cc','admin','','2022-04-06 20:29:18.664956','',1,1);
...
-- Dump completed on 2022-04-13 20:04:53
